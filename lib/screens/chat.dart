...
@override
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        elevation: 0.1,
        leading: IconButton(icon: Icon(!isSelected?Icons.arrow_back_ios:Icons.cancel_sharp), onPressed: (){
          if(isSelected){
            setState(() {
              ...
              child: Row(
                children: [
                  ...
                  IconButton(icon: Icon(Icons.attach_file),onPressed: (){
                    ...
                    .showBottomSheet(
                      (context) => new  BottomSheetWidget(this.conversation,this.socketService),elevation: 0,backgroundColor:Colors.transparent,);
                  },color: mainColor,),
                  IconButton(
